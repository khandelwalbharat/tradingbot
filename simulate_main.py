...
import os
from trading_client import CrocodileEMACrossoverTradingClient, OpeningRangeBreakoutTradingClient
...
def main(args):
    for symbol in args.symbol_list:
        ...
        trading_client = OpeningRangeBreakoutTradingClient(symbol=symbol, start_time=datetime.time(10, 30), end_time=datetime.time(15, 20), simulate=True)
